...
public class ClusterBasedSelectiveStrategy {
	...
	//基于聚类的选择策略
	public List<String> doClusterBasedSelectiveStrategy(Instances input, Classifier[] cfsArray, int numfolds, int numSlots, List<String> pathOfClassifiers,List<String> parameterOfCV)throws Exception{
		int i;
		...
		wcit.IndependentlyTrainWeakClassifiers(input, cfsArray, numfolds,numSlots, pathOfClassifiers, parameterOfCV);

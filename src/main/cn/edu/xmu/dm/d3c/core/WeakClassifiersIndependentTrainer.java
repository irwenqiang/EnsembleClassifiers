...
public class WeakClassifiersIndependentTrainer {
	...
	public List<Classifier> IndependentlyTrainWeakClassifiers(Instances input, Classifier[] cfsArray, double validatePercent, int numSlots, List<String> pathOfClassifiers,List<String> parameterOfCV) throws Exception {
		int i, j;

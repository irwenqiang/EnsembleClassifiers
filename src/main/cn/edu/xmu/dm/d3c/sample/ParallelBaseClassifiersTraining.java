...
public class ParallelBaseClassifiersTraining {
	...
	public List<Classifier> trainingBaseClassifiers(Instances input, Classifier[] cfsArray,
			double validatePercent, int numSlots, List<String> pathOfClassifiers,
		...
		List<Classifier> bcfs = wcit.IndependentlyTrainWeakClassifiers(
				input, cfsArray, validatePercent, numSlots, pathOfClassifiers, parameterOfCV);
		
		return bcfs;
	}

	public List<Integer> run(int numSlots) throws Exception {
		...
		bct.trainingBaseClassifiers(input, cfsArray, numfolds, numSlots, pathOfClassifiers, parameterOfCV);
